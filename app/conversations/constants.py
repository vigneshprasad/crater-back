...
GROUP_TYPE_WEBINAR_ENUM = 2

GROUP_TYPE_GENERIC = "Generic Group"
GROUP_TYPE_AMA = "AMA"
GROUP_TYPE_WEBINAR = "Webinar"

GROUP_PRIVACY_PUBLIC_ENUM = 0
GROUP_PRIVACY_PRIVATE_ENUM = 1

GROUP_PRIVACY_PUBLIC = "public"
GROUP_PRIVACY_PRIVATE = "private"

GROUP_MEDIUM_AUDIO_ENUM = 0
GROUP_MEDIUM_AUDIO_VIDEO_ENUM = 1
GROUP_MEDIUM_CHAT_ENUM = 2
...
INVITE_STATUS_ACCEPTED_ENUM = 1
INVITE_STATUS_DECLINED_ENUM = 2

INVITE_STATUS_PENDING = "pending"
INVITE_STATUS_ACCEPTED = "accepted"
INVITE_STATUS_DECLINED = "declined"

INVITE_TYPE_SPEAKER_ENUM = 0
INVITE_TYPE_ATTENDEE_ENUM = 1
...
PAST_STREAM_FEATURED_CATEGORIES = ["Coding", "Crypto", "Marketing"]
